...
Things you might want to work on: 1. Making code chunks 2. Writing with LaTeX formulas 3. Formatting text with markdown 4. Navigating Rstudio 5. Rendering your QMD 6. Manipulating datasets with `dplyr` 7. Writing pipelines with `%>%` 8. Vector and Matrix Operations
