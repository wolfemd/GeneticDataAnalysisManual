...
[**Advanced Mixed Model Topics**]{.underline}**:** Probable Topics (multi-env. trial analysis, two-stage analysis, GxE, spatial models, heritability)

[**Hands-on Data Wrangling and Exploratory Data Analysis**](5_DataWrangling.qmd){.underline}**:** how to manipulate and plot your data, functions, loops and analyzing multiple traits.
