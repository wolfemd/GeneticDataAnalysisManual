...
> The expected deviation of an individual’s offspring from the population mean, averaged over random mates.
...
+--------------------------------------+-------------+-------------------+-------------+
| Genotype mean\                       | $p^2a$      | $2pqd$            | $−q^2a$     |
| (Freq x Value)                       |             |                   |             |
+--------------------------------------+-------------+-------------------+-------------+
| Genotypic value relative to pop mean | $2q(a−dp)$  | $a(p+q)+d(1-2pq)$ | $−2p(a−dp)$ |
+--------------------------------------+-------------+-------------------+-------------+
| Breeding Value                       | $2𝑞\alpha$  | $(𝑞−𝑝)\alpha$     | $−2𝑝\alpha$ |
+--------------------------------------+-------------+-------------------+-------------+
| Dominance Deviation                  | $-2𝑞^2d$    | $2pqd$            | $-2𝑝^2d$    |
+--------------------------------------+-------------+-------------------+-------------+
...
[Introduction to GWAS in R](8_IntroGWAS.qmd)
